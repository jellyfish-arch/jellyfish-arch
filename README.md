...
🎓 CS Student (AI/ML Track) | 🎮 Game Developer | 💻 Passionate Builder
...
- 🔗 [core-java-journey](https://github.com/jellyfish-arch/core-java-journey) — Java from fundamentals to advanced OOP, with portfolio-ready projects
- 🔗 [advanced-python-journey](https://github.com/jellyfish-arch/advanced-python-journey) — Deep Python: DSA, automation, file handling, testing & more
- 🔗 [dev-portfolio-projects](https://github.com/jellyfish-arch/dev-portfolio-projects) — Polished projects built to showcase real-world skills
